                        ...
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                <div class="row my-2">
                                    ...
                                    <p class="col col-md-9 m-0">: <?php echo $data_detail['namapaket'] ?></p>
                                </div>
                                <div class="row my-2">
                                    <p
                                    <p class="col col-md-9 m-0">: <?php ech class="col col-md-3 fw-bold m-0">Stok</p>o $data_detail['stock'] ?></p>
                                </div>
                                <div class="row my-2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($data_detail_masuk as $item_masuk): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $item_masuk['namapaket']; ?></td>
                                                <td><?php echo $item_masuk['kecepatan']; ?></td>
                                                <td>Barang masuk</td>
                                        ...
                                        <?php foreach($data_detail_keluar as $item_keluar): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $item_keluar['namapaket']; ?></td>
                                                <td><?php echo $item_keluar['kecepatan']; ?></td>
                                                <td>Barang keluar</td>

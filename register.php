...
if(isset($_POST['regis'])) {
    if(register($_POST) > 0) {
        echo "<script>alert('Akun Berhasil Dibuat, silahkan login.');window.location='login_user.php';</script>";
    } else {
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="login_user.php">Sudah punya akun? login disini!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

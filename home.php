                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="edit_stok_barang.php">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="text" name="namapaket" value="<?php echo $item['namapaket']; ?>" class="form-control mb-3" required />
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="tambah_stok_barang.php">
                        <div class="modal-body">
                            ...
                            <input type="text" name="deskripsi" placeholder="Deskripsi Paket" class="form-control mb-3" required />
                        </div>
                        <div class="modal-footer">
